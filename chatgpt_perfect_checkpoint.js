// ============================================
// CONTENT SCRIPT: MASTER CHECKPOINT (ChatGPT Perfect)
// ============================================

console.log('ChatArchive: Master Checkpoint (ChatGPT v12.0) Loaded');
...
async function extractChatGPTContent() {
    ...
    for (const article of articles) {
        ...
        // removed dedeuplication for safety
        if (role === 'user') {
...
// ... UI Logic (abbreviated for checkpoint)
