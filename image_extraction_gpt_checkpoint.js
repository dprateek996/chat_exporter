// ============================================
// CONTENT SCRIPT: CHECKPOINT (Image Extraction Working)
// ============================================

console.log('ChatArchive: Image Extraction Checkpoint Loaded');

// --- 1. IMAGE CAPTURE (Safe Mode) ---
            ...
            for (const img of userImages) {
                if (img.width > 50 && !img.src.includes('svg')) {
                    ...
                    if (!alreadyExists) {
                        ...
                        if (base64) blocks.unshift({ type: 'image', base64: base64, w: img.naturalWidth, h: img.naturalHeight });
                    }
                }
            }
        }
